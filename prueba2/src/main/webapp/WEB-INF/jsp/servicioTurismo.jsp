...
<img src="img/sun.png" width="150" height="120" class="center">
  ...
  <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
   ...
   <ul class="navbar-nav mr-auto mt-2 mt-lg-0">
      ...
      <li class="nav-item">
        <a class="nav-link active" href="servicioTurismo"><h5>Servicio Turismo</h5></a>
      </li>
      <li class="nav-item">
        <a class="nav-link" href="servicioPremium"><h5>Servicio Premium</h5></a>
      </li>
...
<section class="text-center">
  ...
  <tbody>
	...
	<tr>
      <th scope="row">6</th>
      <td>Metro Maquehue</td>
      <td>Plaza Manquehue</td>
      <td>$2.500</td>
	  <td>Turismo</td>
    </tr>
  </tbody>
